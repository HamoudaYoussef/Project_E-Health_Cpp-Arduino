...
void LoginSystem::on_loginButton_clicked()
{
 ...
 connexion c ;
  ...
  QTextToSpeech *l_speech=new QTextToSpeech();
   l_speech->say("bienvenue chez le cabinet de dentiste");

   }
      else
          {   QTextToSpeech *l_speech=new QTextToSpeech();
       l_speech->say("connexion impossible");

       QMessageBox::critical(nullptr, QObject::tr("connexion denyed"),
